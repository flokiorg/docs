...
<div className="release-header-meta release-header-left">
  <a className="github-link release-github no-external-icon" href="https://github.com/flokiorg/tWallet/releases/tag/v1.0.8-beta.2" target="_blank" rel="noreferrer" title="View v1.0.8-beta.2 on GitHub">
    <span className="release-header-label">GitHub</span>
  </a>
</div>

:::info[Hotfix Update: v1.0.8-beta.2]
**Released Dec 19, 2025**

A hotfix has been pushed to address specific issues on **Windows** and update core dependencies.
*   **Windows Fixes**: Resolved keyboard input and window resizing issues (via `tcell` upgrade).
*   **UI Stability**: Removed the TUI resize guard for smoother rendering.
*   **Dependencies**: Bumped `flnd` and `tcell` versions.
...
Additional builds (ppc64, mips, and *BSD) are available on the [GitHub release page](https://github.com/flokiorg/tWallet/releases/tag/v1.0.8-beta.2).
