...
### Data Locations
By default, **tWallet** stores your encrypted database, configuration, and logs in the application data directory of your operating system.
...
:::tip[The loki/ Folder]
Within these directories, you will find a `loki/` subfolder. This contains your active wallet database. **Always back up this folder before making system changes.**
:::
