...
| OS/Arch | Asset |
| --- | --- |
| macOS (Apple Silicon) | https://github.com/flokiorg/tWallet/releases/download/1.0.5-beta/twallet-darwin-arm64-v1.0.5-beta.tar.gz |
| macOS (Intel) | https://github.com/flokiorg/tWallet/releases/download/1.0.5-beta/twallet-darwin-amd64-v1.0.5-beta.tar.gz |
| Linux x86_64 | https://github.com/flokiorg/tWallet/releases/download/1.0.5-beta/twallet-linux-amd64-v1.0.5-beta.tar.gz |
| Linux arm64 (Raspberry Pi) | https://github.com/flokiorg/tWallet/releases/download/1.0.5-beta/twallet-linux-arm64-v1.0.5-beta.tar.gz |
| Windows x86_64 | https://github.com/flokiorg/tWallet/releases/download/1.0.5-beta/twallet-windows-amd64-v1.0.5-beta.zip |
