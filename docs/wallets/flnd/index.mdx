...
To sync your node, you need to connect to at least one active Flokicoin node. You can find a list of reliable peers on the [Loki Explorer](https://lokichain.info/peers).
:::
...
Browse the list of active nodes on the [Loki Explorer](https://lokichain.info/peers) to find a peer to connect your Neutrino node.
:::
...
1. **Find a peer**: Look for nodes on the [Loki Lightning Explorer](https://lokichain.info/lightning).
