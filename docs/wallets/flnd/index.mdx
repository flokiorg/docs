...
Before you can interact with your wallet, the **flnd** daemon must be running. By default, it will wait for you to either create a new wallet or unlock an existing one.

```bash
flnd --flokicoin.active --flokicoin.mainnet --flokicoin.node=neutrino
```
