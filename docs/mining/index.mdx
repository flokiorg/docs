...
## Testnet Mining
For learning and testing purposes, you can use a CPU miner on the testnet network:

- [Gminer](/mining/gminer): A CPU gRPC mining client  
- [Fminer](https://github.com/fpoolnet/fminer): A Stratum CPU mining client
