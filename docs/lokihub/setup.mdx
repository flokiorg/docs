...
#### Option A: Automated Connection (Recommended) {#automated-connection}
...
In tWallet, press <kbd>CTRL</kbd> + <kbd>N</kbd> (or <kbd>Cmd</kbd> + <kbd>N</kbd> on macOS) to open the Lightning configuration window.
