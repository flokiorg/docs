...
Téléchargez les derniers [actifs de la version 1.0.12-beta](https://github.com/flokiorg/tWallet/releases/tag/v1.0.12-beta) depuis GitHub et extrayez-les.
...
| Linux arm64 (Raspberry Pi) | https://github.com/flokiorg/tWallet/releases/download/v1.0.12-beta/twallet-linux-arm64-v1.0.12-beta.tar.gz |
