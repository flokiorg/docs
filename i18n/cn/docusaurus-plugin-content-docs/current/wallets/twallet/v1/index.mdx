...
从 GitHub 下载最新的 [1.0.12-beta 发布资源](https://github.com/flokiorg/tWallet/releases/tag/v1.0.12-beta) 并解压。
...
<Heading as="h3" id="data-locations">数据位置</Heading>
...
<Heading as="h3" id="critical-lightning-backups">至关重要：闪电网络备份</Heading>
...
2. **清除数据**: 删除默认的数据目录（参见上文的 [数据位置](#data-locations)）。
