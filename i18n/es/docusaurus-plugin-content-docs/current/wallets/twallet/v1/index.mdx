...
Descargue los últimos [activos de la versión 1.0.12-beta](https://github.com/flokiorg/tWallet/releases/tag/v1.0.12-beta) de GitHub y extráigalos.
...
<Heading as="h3" id="data-locations">Ubicaciones de datos</Heading>
...
<Heading as="h3" id="critical-lightning-backups">CRÍTICO: Respaldos de Lightning</Heading>
...
2.  **Purgue los datos**: Borre el directorio de datos por defecto (vea [Ubicaciones de datos](#data-locations) más arriba).
